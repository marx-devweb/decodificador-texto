...
const buttonEncrypt = document.querySelector(".js-criptografar");
const buttonDescrypt = document.querySelector(".js-descriptografar");
const display = document.querySelector(".js-display-text");
const buttonCopy = document.querySelector(".btn-copiar");
const image = document.querySelector(".image-chat").cloneNode(true);
const message = document.querySelector(".info-msg").cloneNode(true);
...
function copyText() {
    const image = document.querySelector(".image-chat");
